...
const handlePatientSelect = (index: string) => {
  // 根据index确定患者ID，这里用假数据示例
  const patientId = index === '1' ? 'patient1' : 'patient2'; 
  ...
  <div class="p-4">
    ...
    <div class="space-y-4 mb-6">
      <div class="flex flex-col space-y-2">
        ...
        <el-select v-model="selectedYear" class="w-full" size="large">
      ...
      <div class="flex flex-col space-y-2">
        ...
        <el-select v-model="selectedMonth" class="w-full" size="large" @change="handleMonthChange">
      ...
      <div class="flex flex-col space-y-2">
        ...
        <el-select v-model="selectedDay" class="w-full" size="large">
          <el-option v-for="day in days" :key="day" :label="`${day}日`" :value="day" />
        </el-select>
      </div>
    </div>
    ...
    <div class="mt-4">
      ...
      <el-menu class="border rounded-lg" @select="handlePatientSelect">
