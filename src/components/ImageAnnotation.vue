...
<template>
  <div class="flex h-full">
    <!-- Left Toolbar -->
    <div class="w-80 bg-white border-r p-4 flex flex-col gap-6">
      <!-- Annotation Tools -->
      <div>
...
.mark-box {
  display: flex;
  flex: 1; /* Changed from width: 100% to allow proper flex sizing */
  min-width: 0; /* Added to prevent content from overflowing flex item */
}
